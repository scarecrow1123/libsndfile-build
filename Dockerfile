...
RUN yum update -y && yum install -y git gcc-c++ rsync zip cmake \ 
      make autoconf autogen alsa-lib-devel flac-devel libogg-devel libtool \
      libvorbis-devel opus-devel pkg-config python36
